        ...
        if score is not None:
            ...
            if not survey_mode:
                ...
                if (correct is not None and incorrect is not None
                    ...
                    self.screen.blit(correct_icon, (8, vpos - 20))
                    self.screen.blit(incorrect_icon, (72, vpos - 20))
                    self.screen.blit(unanswered_icon, (136, vpos - 20))
                ...
                size = self.__render_text('[Survey mode on]', (8, vpos))
                hpos = size[0] + 28
