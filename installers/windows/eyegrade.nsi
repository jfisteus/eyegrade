...
;Languages
  ...
  LangString MsgEyegradeRunning ${LANG_SPANISH} \
             "Eyegrade se est� ejecutando. Por favor, ci�rrelo y vu�lvalo a intentar. Si tiene alg�n explorador de ficheros en una carpeta llamada Eyegrade, ci�rrelo tambi�n"
  LangString MsgEyegradeRunning ${LANG_GALICIAN} \
             "Eyegrade estase a executar. Por favor, c�rreo e volva intentalo. Se ten algun explorador de ficheiros aberto nunha carpeta chamada Eyegrade, c�rrea tam�n"
